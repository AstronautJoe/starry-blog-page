...
?>		<h2>Register</h2>
		<form action="process.php" method="POST">
			...
			<label for="first_name">First Name:</label><input type="text" name="first_name" placeholder="Juan">
			<label for="last_name">Last Name:</label><input type="text" name="last_name" placeholder="Santa Maria">
			<label for="email">E-mail:</label><input type="email" name="email" placeholder="juandelacruz@yahoo.com">
			<label for="password">Password:</label><input type="password" name="password" placeholder="password">
			<label for="confirm_password">Confirm Password:</label><input type="password" name="confirm_password" placeholder="Repeat above password">
